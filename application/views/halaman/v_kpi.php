                        ...
                        <!-- /.card-header -->
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="mr-1">
                                            <?php echo anchor('Data_karyawan/detail_karyawan/' . $divisi['id_divisi'], '<div class="btn btn-block btn-md btn-secondary"><i class="fas fa-arrow-left p-1" style="color:white;" title="Kembali"></i></div>'); ?>
                                        </div>
                                        <div>
                            ...
                            <table class="table col-12 col-lg-6 table-hover" style="table-layout: fixed; word-wrap: break-word;" >
                                ...
                                <tbody>
                                    <?php $no=1; foreach ($kpi_data as $kpi): ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
