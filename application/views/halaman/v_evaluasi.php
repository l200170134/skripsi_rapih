                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <div class="alert alert-sm alert-success alert-dismissible m-3">
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <p class="text-sm m-0">
                                              MA(1) : Total sales<br>
                                              MA(2) : Kenaikan total sales<br>
                                              MA(3) : Jumlah pelanggan baru<br>
                                          </p>
                                      </div>
                                      <div class="col-lg-6">
                                          <p class="text-sm m-0">
                                              MA(4) : Kenaikan jumlah pelanggan baru<br>
                                              MA(5) : Project marketing<br>
                                          </p>
                                      </div>
                                  </div>
                                  ...
                                  <table class="table table-bordered table-hover" style="table-layout: fixed; word-wrap: break-word;">
                                      <thead>
                                          <tr align="center">
                                              ...
                                              <th width="140px">MA(1)</th>
                                              <th width="140px">MA(2)</th>
                                              <th width="140px">MA(3)</th>
                                              <th width="140px">MA(4)</th>
                                              <th width="140px">MA(5)</th>
                                              <th width="80px">Point</th>
                                              <th width="160px">Keterangan</th>
                                          </tr>
                                      </thead>
                                      <tr align="center">
                                          <td>1</td>
