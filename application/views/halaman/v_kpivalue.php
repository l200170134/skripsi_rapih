                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Value Key Performance Index</h5>
                        </div>
                        <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        ?>
                                        <div class="mr-1">
                                            <?php echo anchor('Evaluasi', '<div class="btn btn-block btn-md btn-secondary"><i class="fas fa-arrow-left p-1" style="color:white;" title="Kembali"></i></div>'); ?>
                                        </div>
                                        <div>
                                            <?php echo anchor('Evaluasi/kpivalue_form/' . $user['nip'], '<div class="btn btn-block btn-md btn-success"><i class="fas fa-plus p-1" style="color:white;" title="Tambah Data"></i>KPI Value</div>'); ?>
                                        </div>
                                        <?php
                                            }
                                         ?>
                            ...
                            <table class="table col-12 col-lg-6 table-hover" style="table-layout: fixed; word-wrap: break-word;" >
                                ...
                                <thead>
                                    <?php 
                                        ...
                                        ?>
                                    <tr class="bg-primary"><td colspan="4" align="center" height="15x"><?php echo $user['nama']; ?></td></tr>
                                    <?php
                                            }
                                         ?>
