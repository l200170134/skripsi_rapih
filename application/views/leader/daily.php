                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" onclick="javascript: return confirm('Anda yakin ingin menghapus')">
                          <?php  echo anchor('leader/Leader/daily_proses_hapus/'.$dy->id, '<div class="btn btn-danger ml-2"><i class="fas fa-trash"></i></div>'); ?>
                        </td>
                        <td align="center">
                          <?php  echo anchor('leader/Leader/daily_update/'.$dy->id,'<div class="btn btn-warning"><i class="fas fa-edit" style="color:white;"></i></div>'); ?>
                        </td>
                      </tr>
                      <?php endforeach ?>
                    </tbody>
